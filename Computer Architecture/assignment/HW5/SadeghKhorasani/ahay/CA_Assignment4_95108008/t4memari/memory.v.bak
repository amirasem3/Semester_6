module memory(clk,reset,address,data_in,data_out,rwn,start,ready,address_test1,address_test2,address_test3,data_test1,data_test2,data_test3);
	...
	begin
		if(reset) begin
			...
			array[1] <= 8'b0010_1000;
			array[2] <= 8'b0000_0000;
			array[3] <= 8'b0000_0000;
			array[4] <= 8'b0000_0000;
			array[36] <= 8'b0000_0010;
			array[40] <= 8'b0000_0010;
			array[5] <= 8'b1001_1111;
			array[6] <= 8'b0000_0100;
			array[7] <= 8'b0000_0001;
			array[8] <= 8'b0000_0000;
			array[9] <= 8'b0000_0000;
			array[10] <= 8'b0110_0000;
